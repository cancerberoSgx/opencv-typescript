...
constants, filtered to only what opencv.js actually registered in bindings.cpp."""
...
def render_group(
    ...
    functions = [
        f for f in compound.functions if is_valid_id(f.name) and f.name in registered_function_names
    ]
