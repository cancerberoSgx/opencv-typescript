...
opencv-ts must be autogenerated by opencv-types-generator 100% unfortunately there are parts of the project like the README.md that are not. Make sure you generate everything from opencv-types-generator using templates so I can delete the project and run generator again without loosing any content
