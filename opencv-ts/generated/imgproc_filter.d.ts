...
import type { Point, Scalar, Size, TermCriteria } from '../hacks/scalars';
 ...
 *
 * The function applies bilateral filtering to the input image, as described in https://homepages.inf.ed.ac.uk/rbf/CVonline/LOCAL_COPIES/MANDUCHI1/Bilateral_Filtering.html (https://homepages.inf.ed.ac.uk/rbf/CVonline/LOCAL_COPIES/MANDUCHI1/Bilateral_Filtering.html) bilateralFilter can reduce unwanted noise very well while keeping edges fairly sharp. However, it is very slow compared to most filters.
 *
 *
 ...
 */
export declare function bilateralFilter(src: InputArray, dst: OutputArray, d: number, sigmaColor: number, sigmaSpace: number, borderType?: number): void
 ...
 */
export declare function blur(src: InputArray, dst: OutputArray, ksize: Size, anchor?: Point, borderType?: number): void
 ...
 * @param borderType border mode used to extrapolate pixels outside of the image, see BorderTypes. BORDER_WRAP is not supported.
 */
export declare function boxFilter(src: InputArray, dst: OutputArray, ddepth: number, ksize: Size, anchor?: Point, normalize?: boolean, borderType?: number): void
 ...
 * @param dst output image of the same size and type as src.
 * @param kernel structuring element used for dilation; if `kernel=Mat()`, a `3 x 3` rectangular structuring element is used. Kernel can be created using getStructuringElement
 ...
 */
export declare function dilate(src: InputArray, dst: OutputArray, kernel: InputArray, anchor?: Point, iterations?: number, borderType?: number, borderValue?: any): void
 ...
 * @param src input image; the number of channels can be arbitrary, but the depth should be one of CV_8U, CV_16U, CV_16S, CV_32F or CV_64F.
 * @param dst output image of the same size and type as src.
 * @param kernel structuring element used for erosion; if `kernel=Mat()`, a `3 x 3` rectangular structuring element is used. Kernel can be created using getStructuringElement.
 * @param anchor position of the anchor within the element; default value (-1, -1) means that the anchor is at the element center.
 * @param iterations number of times erosion is applied.
 * @param borderType pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
 * @param borderValue border value in case of a constant border
 */
export declare function erode(src: InputArray, dst: OutputArray, kernel: InputArray, anchor?: Point, iterations?: number, borderType?: number, borderValue?: any): void

export declare function filter2D(src: InputArray, dst: OutputArray, kernel: InputArray, params?: any): void
 ...
 * @param borderType pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
 */
export declare function filter2D(src: InputArray, dst: OutputArray, ddepth: number, kernel: InputArray, anchor?: Point, delta?: number, borderType?: number): void
 ...
 */
export declare function GaussianBlur(src: InputArray, dst: OutputArray, ksize: Size, sigmaX: number, sigmaY?: number, borderType?: number, hint?: AlgorithmHint): void

/**
 * Returns filter coefficients for computing spatial image derivatives.
 *
 * The function computes and returns the filter coefficients for spatial image derivatives. When `ksize=FILTER_SCHARR`, the Scharr  kernels are generated (see Scharr). Otherwise, Sobel kernels are generated (see Sobel). The filters are normally passed to sepFilter2D or to
 *
 ...
 * @param normalize Flag indicating whether to normalize (scale down) the filter coefficients or not. Theoretically, the coefficients should have the denominator . If you are going to filter floating-point images, you are likely to use the normalized kernels. But if you compute derivatives of an 8-bit image, store the results in a 16-bit image, and wish to preserve all the fractional bits, you may want to set normalize=false .
 * @param ktype Type of filter coefficients. It can be CV_32f or CV_64F .
 */
export declare function getDerivKernels(kx: OutputArray, ky: OutputArray, dx: number, dy: number, ksize: number, normalize?: boolean, ktype?: number): void

/**
 * Returns Gabor filter coefficients.
 *
 * For more details about gabor filter equations and parameters, see: Gabor Filter (https://en.wikipedia.org/wiki/Gabor_filter).
 *
 ...
 * @param ktype Type of filter coefficients. It can be CV_32F or CV_64F .
 */
export declare function getGaborKernel(ksize: Size, sigma: number, theta: number, lambd: number, gamma: number, psi?: number, ktype?: number): Mat
 ...
 * @param ktype Type of filter coefficients. It can be CV_32F or CV_64F .
 */
export declare function getGaussianKernel(ksize: number, sigma: number, ktype?: number): Mat
 ...
 */
export declare function getStructuringElement(shape: number, ksize: Size, anchor?: Point): Mat
 ...
 * @param borderType Pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
 */
export declare function Laplacian(src: InputArray, dst: OutputArray, ddepth: number, ksize?: number, scale?: number, delta?: number, borderType?: number): void
 ...
 */
export declare function medianBlur(src: InputArray, dst: OutputArray, ksize: number): void
 ...
 */
export declare function morphologyEx(src: InputArray, dst: OutputArray, op: number, kernel: InputArray, anchor?: Point, iterations?: number, borderType?: number, borderValue?: any): void
 ...
 */
export declare function pyrDown(src: InputArray, dst: OutputArray, dstsize?: any, borderType?: number): void
 ...
 */
export declare function pyrMeanShiftFiltering(src: InputArray, dst: OutputArray, sp: number, sr: number, maxLevel?: number, termcrit?: TermCriteria): void
 ...
 */
export declare function pyrUp(src: InputArray, dst: OutputArray, dstsize?: any, borderType?: number): void
 ...
 * @param borderType pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
 */
export declare function Scharr(src: InputArray, dst: OutputArray, ddepth: number, dx: number, dy: number, scale?: number, delta?: number, borderType?: number): void
 ...
 * @param anchor Anchor position within the kernel. The default value  means that the anchor is at the kernel center.
 * @param delta Value added to the filtered results before storing them.
 * @param borderType Pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
 */
export declare function sepFilter2D(src: InputArray, dst: OutputArray, ddepth: number, kernelX: InputArray, kernelY: InputArray, anchor?: Point, delta?: number, borderType?: number): void
 ...
 *
 *
 * There is also the special value `ksize = #FILTER_SCHARR (-1)` that corresponds to the  Scharr filter that may give more accurate results than the  Sobel. The Scharr aperture is
 *
 *
 *
 *
 ...
 * @param borderType pixel extrapolation method, see BorderTypes. BORDER_WRAP is not supported.
 */
export declare function Sobel(src: InputArray, dst: OutputArray, ddepth: number, dx: number, dy: number, ksize?: number, scale?: number, delta?: number, borderType?: number): void
 ...
 */
export declare function spatialGradient(src: InputArray, dx: OutputArray, dy: OutputArray, ksize?: number, borderType?: number): void
 ...
 * @param borderType border mode used to extrapolate pixels outside of the image, see BorderTypes. BORDER_WRAP is not supported.
 */
export declare function sqrBoxFilter(src: InputArray, dst: OutputArray, ddepth: number, ksize: Size, anchor?: Point, normalize?: boolean, borderType?: number): void

/**
 * Blurs an image using the stackBlur.
 *
 * The function applies and stackBlur to an image. stackBlur can generate similar results as Gaussian blur, and the time consumption does not increase with the increase of kernel size. It creates a kind of moving stack of colors whilst scanning through the image. Thereby it just has to add one new block of color to the right side of the stack and remove the leftmost color. The remaining colors on the topmost layer of the stack are either added on or reduced by one, depending on if they are on the right or on the left side of the stack. The only supported borderType is BORDER_REPLICATE. Original paper was proposed by Mario Klingemann, which can be found https://underdestruction.com/2004/02/25/stackblur-2004 (https://underdestruction.com/2004/02/25/stackblur-2004).
 *
 * @param src input image. The number of channels can be arbitrary, but the depth should be one of CV_8U, CV_16U, CV_16S or CV_32F.
 * @param dst output image of the same size and type as src.
 * @param ksize stack-blurring kernel size. The ksize.width and ksize.height can differ but they both must be positive and odd.
 */
export declare function stackBlur(src: InputArray, dst: OutputArray, ksize: Size): void

/**
 * a rectangular structuring element:
 */
export declare const MORPH_RECT: number

/**
 * a cross-shaped structuring element:
 */
export declare const MORPH_CROSS: number
 ...
 */
export declare const MORPH_ELLIPSE: number

/**
 * a diamond structuring element defined by Manhattan distance
 */
export declare const MORPH_DIAMOND: number

/**
 * see erode
 */
export declare const MORPH_ERODE: number

/**
 * see dilate
 */
export declare const MORPH_DILATE: number

/**
 * an opening operation
 */
export declare const MORPH_OPEN: number

/**
 * a closing operation
 */
export declare const MORPH_CLOSE: number

/**
 * a morphological gradient
 */
export declare const MORPH_GRADIENT: number

/**
 * "top hat"
 */
export declare const MORPH_TOPHAT: number

/**
 * "black hat"
 */
export declare const MORPH_BLACKHAT: number

/**
 * "hit or miss" .- Only supported for CV_8UC1 binary images. A tutorial can be found in the documentation
 */
export declare const MORPH_HITMISS: number

export declare const FILTER_SCHARR: number
